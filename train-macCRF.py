...
parser.add_argument('--bert_model_dir', default='hfl/chinese-macbert-base',
                    help="Directory containing the BERT model in PyTorch")
parser.add_argument('--model_dir', default='experiments/base_model_CRF', help="Directory containing params.json")
